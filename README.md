...
<img height="160" src="https://github.com/user-attachments/assets/9e140879-2e1a-4b9b-a167-ecf66679e60c">

<h1>Factorio Better Chinese Fonts</h1>

Add better Chinese font support for Factorio.
...
![](https://github.com/user-attachments/assets/960ccdb3-f345-42f6-8526-8ef30c2f358b)
...
- [x] **🈶 Better Chinese Fonts**: Add HarmonyOS Sans fonts for Factorio.
- [x] **🤗 Rich Emoji**: Support emoji display.
- [x] **🌐 Internationalization**: Support zh-CN, zh-TW.
...
```bash
$ git clone https://github.com/canisminor1990/factorio-better-chinese-fonts.git
$ cd factorio-better-chinese-fonts
$ bun install
$ bun dev
```
